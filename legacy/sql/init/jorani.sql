...
--
INSERT INTO
    `organization` (`id`, `name`, `parent_id`)
VALUES (0, 'LMS root', -1);
...
VALUES (
        ...
        'jorani',
        'jorani@example.org',
        '$2a$08$My0FoP4zalOiS2OM6rsCz.XXozSW1UiqRq4zKup/CC/kOxXDCs9Zm',
        1,
        1,
        NULL,
        0,
    ...
    (
        ...
        'jdoe',
        'jdoe@example.org',
        '$2a$08$TU9Syb0FTqcKGwAg5AtH.OLThxcR3p.1gKEcorxvbuqKWTyHQRI7y',
        2,
        1,
        NULL,
        0,
