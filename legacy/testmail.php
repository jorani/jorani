    ...
    <div class="container">
        ...
        <h3>Troubleshooting</h2>
            ...
            <ul>
                ...
                <li>If you are using GMAIL, please read <a target="_blank"
                        href="https://support.google.com/mail/answer/78775?hl=en">this article</a>.</li>
                <li>The STMP port may be blocked by your organization/server's security policy (firewall, etc.).</li>
                <li>When running SELinux, the webserver is blocked by default (it cannot send e-mails or open a network
                    connection). Please consider unblocking it:
                    <p>
                    <pre>
                ...
                <li>Some e-mail servers (eg Office 360) require to set a valid sender e-mail. Update
                ...
                <li>Some SMTP server require the application server sending emails (i.e. Jorani) to be whitelisted (on
                    the SMTP server).</li>
