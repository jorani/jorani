  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
      <a href="<?php echo base_url(); ?>home" class="brand">&nbsp;<img
          src="<?php echo base_url(); ?>assets/images/brand.png" height="18" width="18"
          style="margin-top:-6px;">&nbsp;Jorani</a>
      <div class="nav-responsive">
        <ul class="nav">
          ...
          <?php if ($is_hr == TRUE) { ?>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a
                    href="<?php echo base_url(); ?>reports/balance"><?php echo lang('menu_hr_report_leave_balance'); ?></a>
                </li>
          ...
          <?php if ($is_manager == TRUE) { ?>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a
                    href="<?php echo base_url(); ?>requests/delegations"><?php echo lang('menu_validation_delegations'); ?></a>
                </li>
                <li><a
        ...
        <ul class="nav pull-right">
          ...
          <li><a href="<?php echo base_url() . $urlLogout; ?>" title="<?php echo lang('menu_banner_logout'); ?>"><i
                class="mdi mdi-logout"></i></a></li>
        </ul>
      </div>
    </div>
  </div><!-- /.navbar -->
