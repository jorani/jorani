...
<div class="row-fluid">
    <div class="span12">
        ...
        <h2><?php echo lang('requests_delegations_title'); ?> <span class="muted">(<?php echo $name; ?>)</span>
            &nbsp;<?php echo $help; ?></h2>

        <div class="row-fluid">
            <div class="span12"><?php echo lang('requests_delegations_description'); ?></div>
        </div>
            ...
            <tbody>
                <?php foreach ($delegations as $delegation) { ?>
                    <tr data-id="<?php echo $delegation['id']; ?>">
                        <td><a href="#" onclick="delete_delegation(<?php echo $delegation['id'] ?>);"
                                title="<?php echo lang('requests_delegations_thead_tip_delete'); ?>"><i
                                    class="mdi mdi-close nolink"></i></a></td>
        ...
        <button id="cmdAddDelegate" class="btn btn-primary" onclick="$('#frmSelectDelegate').modal('show');"><i
                class="mdi mdi-account-search"></i>&nbsp;<?php echo lang('requests_delegations_button_add'); ?></button>
        <div class="row-fluid">
            <div class="span12">&nbsp;</div>
        </div>
...
<div id="frmSelectDelegate" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_delegate();"
            class="btn"><?php echo lang('requests_delegations_popup_delegate_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectDelegate').modal('hide');"
            class="btn"><?php echo lang('requests_delegations_popup_delegate_button_cancel'); ?></a>
    </div>
</div>
