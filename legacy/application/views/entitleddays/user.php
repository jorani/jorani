...
<div class="row-fluid">
    <div class="span12">
        ...
        <h2><?php echo lang('entitleddays_user_index_title'); ?> <span
                class="muted"><?php echo $employee_name; ?></span>&nbsp;<?php echo $help; ?></h2>
            ...
            <tbody>
                <?php foreach ($entitleddays as $days) { ?>
                    <tr data-id="<?php echo $days['id'] ?>">
                        <td>
                            <a href="#" onclick="delete_entitleddays(<?php echo $days['id']; ?>);"
                                title="<?php echo lang('entitleddays_user_index_thead_tip_delete'); ?>"><i
                                    class="mdi mdi-close nolink"></i></a>
                            &nbsp;<a href="#" onclick="copy_entitleddays(<?php echo $days['id']; ?>);"
                                title="<?php echo lang('entitleddays_user_index_thead_tip_copy'); ?>"><i
                                    class="mdi mdi-content-copy nolink"></i></a>
                            &nbsp;<a href="#" onclick="show_edit_entitleddays(<?php echo $days['id']; ?>);"
                                title="<?php echo lang('entitleddays_user_index_thead_tip_edit'); ?>"><i
                                    class="mdi mdi-pencil nolink"></i></a>
                            <?php if (!is_null($days['overtime'])) { ?>
                                &nbsp;<a href="<?php echo base_url(); ?>extra/entitleddays/<?php echo $days['id']; ?>"
                                    title="<?php echo lang('overtime_index_thead_tip_view'); ?>"><i
                                        class="mdi mdi-eye nolink"></i></a>
                            <?php } ?>
                        </td>
                        <?php $startDate = new DateTime($days['startdate']);
                        $endDate = new DateTime($days['enddate']); ?>
                        <td data-order="<?php echo $startDate->getTimestamp(); ?>">
                            <?php echo $startDate->format(lang('global_date_format')); ?>
                        </td>
                        <td data-order="<?php echo $endDate->getTimestamp(); ?>">
                            <?php echo $endDate->format(lang('global_date_format')); ?>
                        </td>
                        <td data-order="<?php echo $days['days']; ?>"><span
                                id="days<?php echo $days['id']; ?>"><?php echo $days['days']; ?></span> &nbsp; <a href="#"
                                onclick="Javascript:incdec(<?php echo $days['id']; ?>, 'decrease');"><i
                                    class="mdi mdi-minus nolink"></i></a>
                            &nbsp; <a href="#" onclick="Javascript:incdec(<?php echo $days['id']; ?>, 'increase');"><i
                                    class="mdi mdi-plus nolink"></i></a></td>
        ...
        <div class="row-fluid">
            <div class="span6">
                <a href="<?php echo base_url(); ?>hr/employees" class="btn btn-danger"><i
                        class="mdi mdi-arrow-left-bold"></i>&nbsp;<?php echo lang('entitleddays_user_index_button_back'); ?></a>
                <button id="cmdAddEntitledDays" class="btn btn-primary" onclick="show_add_entitleddays();"><i
                        class="mdi mdi-plus-circle"></i>&nbsp;<?php echo lang('entitleddays_user_index_button_add'); ?></button>
            </div>
            <div class="span6">
...
<div id="frmAddEntitledDays" class="modal hide fade">
    ...
    <div class="modal-body">
        ...
        <div class="input-append">
            ...
            <button class="btn" id="cmdCurrent"
                onclick="set_current_period();"><?php echo lang('entitleddays_contract_index_button_current'); ?></button>
        </div>
        <br />
    ...
    <div class="modal-footer">
        <button id="cmdFrmSaveEntitledDays" class="btn btn-primary"
            onclick="edit_entitleddays();"><?php echo lang('OK'); ?></button>
        <button id="cmdFrmAddEntitledDays" class="btn btn-primary"
            onclick="add_entitleddays();"><?php echo lang('entitleddays_user_index_button_add'); ?></button>
