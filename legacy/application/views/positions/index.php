                    ...
                    <tr>
                        <td data-order="<?php echo $position['id']; ?>">
                            ...
                            <div class="pull-right">
                                <a href="#" class="confirm-delete" data-id="<?php echo $position['id']; ?>"
                                    title="<?php echo lang('positions_index_thead_tip_delete'); ?>"><i
                                        class="mdi mdi-delete nolink"></i></a>&nbsp;
                                <a href="<?php echo base_url(); ?>positions/edit/<?php echo $position['id']; ?>"
                                    title="<?php echo lang('positions_index_thead_tip_edit'); ?>"><i
...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url(); ?>positions/export" class="btn btn-primary"><i
                class="mdi mdi-download"></i>&nbsp;<?php echo lang('positions_index_button_export'); ?></a>
        &nbsp;
        <a href="<?php echo base_url(); ?>positions/create" class="btn btn-primary"><i
                class="mdi mdi-plus-circle"></i>&nbsp;<?php echo lang('positions_index_button_create'); ?></a>
    </div>
</div>
...
<div id="frmDeletePosition" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeletePosition"
            class="btn btn-danger"><?php echo lang('positions_index_popup_button_yes'); ?></a>
        <a href="#" onclick="$('#frmDeletePosition').modal('hide');"
            class="btn"><?php echo lang('positions_index_popup_button_no'); ?></a>
    </div>
</div>
