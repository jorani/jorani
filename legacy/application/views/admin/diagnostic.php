  ...
  <div class="span12">
    ...
    <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab"
          href="#daysoff"><?php echo $daysOffYears_badge . lang('admin_diagnostic_daysoff_tab'); ?></a></li>
      <li><a data-toggle="tab"
          href="#requests"><?php echo $duplicatedLeaves_badge . lang('admin_diagnostic_requests_tab'); ?></a></li>
      <li><a data-toggle="tab"
          href="#datetypes"><?php echo $wrongDateType_badge . lang('admin_diagnostic_datetype_tab'); ?></a></li>
      <li><a data-toggle="tab"
          href="#entitlements"><?php echo $entitlmentOverflow_badge . lang('admin_diagnostic_entitlements_tab'); ?></a>
      </li>
      <li><a data-toggle="tab"
          href="#overtime"><?php echo $negativeOvertime_badge . lang('admin_diagnostic_overtime_tab'); ?></a></li>
      <li><a data-toggle="tab"
          href="#contracts"><?php echo $unusedContracts_badge . lang('admin_diagnostic_contract_tab'); ?></a></li>
      <li><a data-toggle="tab"
          href="#balance"><?php echo $leaveBalance_badge . lang('admin_diagnostic_balance_tab'); ?></a></li>
      <li><a data-toggle="tab"
          href="#overlapping"><?php echo $overlappingLeaves_badge . lang('admin_diagnostic_overlapping_tab'); ?>&nbsp;<i
            class="mdi mdi-test-tube mdi-rotate-45" title="Beta"></i></a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <table class="table table-bordered table-hover table-condensed">
          ...
          <tbody>
            <?php foreach ($daysOffYears as $yearDef): ?>
              <tr>
                <td><a target="_blank"
                    href="<?php echo base_url(); ?>contracts/<?php echo $yearDef['contract']; ?>/calendar"><?php echo $yearDef['contract']; ?></a>
                </td>
          ...
          <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
              <?php foreach ($duplicatedLeaves as $leave):
                ...
                <tr>
                  <td><a target="_blank"
                      href="<?php echo base_url(); ?>leaves/edit/<?php echo $leave['id']; ?>"><?php echo $leave['id']; ?></a>
                  </td>
          ...
          <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
              <?php foreach ($wrongDateType as $dateType):
                ...
                <tr>
                  <td><a target="_blank"
                      href="<?php echo base_url(); ?>leaves/edit/<?php echo $dateType['id']; ?>"><?php echo $dateType['id']; ?></a>
                  </td>
            ...
            <tbody>
              <?php foreach ($entitlmentOverflow as $entitlment):
                ...
                if (!is_null($entitlment['contract'])) { ?>
                  <tr>
                    <td><a target="_blank"
                        href="<?php echo base_url(); ?>entitleddays/contract/<?php echo $entitlment['contract']; ?>"><?php echo $entitlment['id']; ?></a>
                    </td>
                    <td><?php echo lang('admin_diagnostic_entitlements_type_contract'); ?></td>
                    <td>
                      <?php echo (is_null($entitlment['contract_label']) ? lang('admin_diagnostic_entitlements_deletion_problem') : $entitlment['contract_label']); ?>
                    </td>
                    <td><?php echo $startdate; ?></td>
                ...
                <?php } else { ?>
                  <tr>
                    <td><a target="_blank"
                        href="<?php echo base_url(); ?>entitleddays/user/<?php echo $entitlment['employee']; ?>"><?php echo $entitlment['id']; ?></a>
                    </td>
                    <td><?php echo lang('admin_diagnostic_entitlements_type_employee'); ?></td>
                    <td>
                      <?php echo (is_null($entitlment['user_label']) ? lang('admin_diagnostic_entitlements_deletion_problem') : $entitlment['user_label']); ?>
                    </td>
                    <td><?php echo $startdate; ?></td>
                    <td><?php echo $enddate; ?></td>
                  </tr>
          ...
          <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
              <?php foreach ($negativeOvertime as $overtime):
                ...
                <tr>
                  <td><a target="_blank"
                      href="<?php echo base_url(); ?>extra/edit/<?php echo $overtime['id']; ?>"><?php echo $overtime['id']; ?></a>
                  </td>
      ...
      <div class="tab-pane" id="contracts">
        <p><a target="_blank"
            href="<?php echo base_url(); ?>contracts"><?php echo lang('admin_diagnostic_contract_description'); ?></a>
        </p>
          ...
          <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
              <?php foreach ($leaveBalance as $balance):
                ...
                <tr>
                  <td><a target="_blank"
                      href="<?php echo base_url(); ?>leaves/edit/<?php echo $balance['id']; ?>"><?php echo $balance['id']; ?></a>
                  </td>
                  <td>
                    <a target="_blank"
                      href="<?php echo base_url(); ?>hr/counters/employees/<?php echo $balance['employee']; ?>"><i
                        class="mdi mdi-information-outline nolink"></i></a>
                    <a target="_blank"
                      href="<?php echo base_url(); ?>entitleddays/user/<?php echo $balance['employee']; ?>"><i
                        class="mdi mdi-pencil-box-outline nolink"></i></a>
                    <?php echo $balance['user_label']; ?>
                  </td>
                  <td>
                    <a target="_blank"
                      href="<?php echo base_url(); ?>entitleddays/contract/<?php echo $balance['employee']; ?>"><i
                        class="mdi mdi-pencil-box-outline nolink"></i></a>
            ...
            <tbody>
              <?php foreach ($overlappingLeaves as $leave):
                ...
                <tr>
                  ...
                  <td>
                    <a target="_blank"
                      href="<?php echo base_url(); ?>contracts/edit/<?php echo $leave['contract_id']; ?>"><?php echo $leave['contract_label']; ?></a>
                  </td>
                  <td><?php echo $startdate; ?></td>
                  <td><?php echo $enddate; ?></td>
