...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#clients"><?php echo lang('admin_oauthclients_tab_clients'); ?></a>
    </li>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="clients">
                    ...
                    <tbody>
                        <?php foreach ($clients as $client): ?>
                            <tr data-id="<?php echo $client['client_id']; ?>">
                                <td>
                                    <a href="#" class="confirm-delete" data-id="<?php echo $client['client_id']; ?>"
                                        title="<?php echo lang('admin_oauthclients_thead_tip_delete'); ?>"><i
        ...
        <div class="row-fluid">
            <div class="span12">
                <button onclick="$('#frmAddClient').modal('show');" class="btn btn-primary"><i
                        class="mdi mdi-plus-circle"></i>&nbsp;<?php echo lang('admin_oauthclients_button_add'); ?></button>
                &nbsp;
            </div>
        </div>
    </div>
...
<div id="frmAddClient" class="modal hide fade">
    ...
    <div class="modal-footer">
        ...
        <button onclick="$('#frmAddClient').modal('hide');"
            class="btn btn-danger"><?php echo lang('Cancel'); ?></button>
    </div>
</div>
