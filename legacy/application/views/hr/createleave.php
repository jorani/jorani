...
<div class="row-fluid">
    <div class="span8">
        ...
        <label for="duration" required><?php echo lang('hr_leaves_create_field_duration'); ?> <span
        ...
        <select name="status">
            <option value="1" <?php if ($this->config->item('leave_status_requested') == FALSE)
                echo 'selected'; ?>>
                <?php echo lang('Planned'); ?>
            </option>
            <option value="2" <?php if ($this->config->item('leave_status_requested') == TRUE)
                echo 'selected'; ?>>
        ...
        <button type="submit" class="btn btn-primary"><i class="mdi mdi-check"></i>&nbsp;
            <?php echo lang('hr_leaves_create_button_create'); ?></button>
        &nbsp;
        <a href="<?php echo base_url() . $source; ?>" class="btn btn-danger"><i class="mdi mdi-close"></i>&nbsp;
            <?php echo lang('hr_leaves_create_button_cancel'); ?></a>
        </form>
