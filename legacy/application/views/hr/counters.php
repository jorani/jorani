...
<div class="row-fluid">
    <div class="span12">
        <h2><?php echo lang('hr_summary_title'); ?>&nbsp;<?php echo $employee_id; ?>&nbsp;<span class="muted">
                (<?php echo $employee_name; ?>)</span>&nbsp;<?php echo $help; ?></h2>
...
<div class="row-fluid">
    <div class="span12">
        <?php if ($source == 'employees') { ?>
            <h3><a
                    href="<?php echo base_url(); ?>entitleddays/contract/<?php echo $contract_id; ?>"><?php echo lang('entitleddays_counters_title_contract'); ?><?php echo $contract_id; ?></a>&nbsp;<span
                    class="muted"> (<?php echo $contract_name; ?>)</span></h3>
        <?php } else { ?>
            <h3><?php echo lang('entitleddays_counters_title_contract') . ' ' . $contract_id; ?>&nbsp;<span class="muted">
                    (<?php echo $contract_name; ?>)</span></h3>
        <?php } ?>
        <p><?php echo lang('entitleddays_counters_description_contract'); ?><?php echo $contract_start; ?> -
...
<div class="row-fluid">
    <div class="span12">
        <?php if ($source == 'employees') { ?>
            <h3><a
                    href="<?php echo base_url(); ?>entitleddays/user/<?php echo $employee_id; ?>"><?php echo lang('entitleddays_counters_title_employee'); ?></a>
            </h3>
        <?php } else { ?>
    ...
    <div class="span3">
        <?php if ($source == 'employees') { ?>
            <a href="<?php echo base_url(); ?>hr/employees" class="btn btn-primary"><i
                    class="mdi mdi-arrow-left-bold"></i>&nbsp;<?php echo lang('hr_summary_button_list'); ?></a>
        <?php } else { ?>
...
<script type="text/javascript">
    $(function () {
        ...
        reportDate = '<?php $date = new DateTime($refDate);
        echo $date->format(lang('global_date_format')); ?>';
