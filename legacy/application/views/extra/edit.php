...
<h2><?php echo lang('extra_edit_title'); ?><?php echo $extra['id']; ?>&nbsp;<span
        class="muted">(<?php echo $name ?>)</span>&nbsp;<?php echo $help; ?></h2>
...
<input type="text" name="viz_date" id="viz_date" value="<?php $date = new DateTime($extra['date']);
...
<input type="text" name="duration" id="duration" value="<?php echo $extra['duration']; ?>"
    required />&nbsp;<span><?php echo lang('extra_edit_field_duration_description'); ?></span>
...
<select name="status" required>
    <option value="1" <?php if ($extra['status'] == 1)
        echo 'selected'; ?>><?php echo lang('Planned'); ?></option>
    <option value="2" <?php if (($extra['status'] == 2) || $this->config->item('extra_status_requested'))
        echo 'selected'; ?>><?php echo lang('Requested'); ?></optio n>
        <?php if ($is_hr) { ?>
        <option value="3" <?php if ($extra['status'] == 3)
            echo 'selected'; ?>><?php echo lang('Accepted'); ?></option>
        <option value="4" <?php if ($extra['status'] == 4)
...
<div class="row-fluid">
    <div class="span12">
        <button id="cmdEditExtra" class="btn btn-primary"><i class="mdi mdi-check"></i>&nbsp;
