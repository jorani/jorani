...
<h2><?php echo lang('contract_exclude_title'); ?>&nbsp;<span
        class="muted">(<?php echo $contract['name']; ?>)</span>&nbsp;<?php echo $help; ?></h2>
                            ...
                            <td>
                                <div class="pull-right">
                                    ...
                                    <?php if ($typesUsage[$typeId] == 0 && $defaultType != $typeId) { ?>
                                        <a href="#" class="exclude" data-id="<?php echo $typeId; ?>"
                                            title="<?php echo lang('contract_exclude_tip_exclude_type'); ?>"><i
                                                class="mdi mdi-close nolink"></i></a>
                                    <?php } else { ?>
                                        <span class="badge badge-info"><?php echo $typesUsage[$typeId]; ?></span>
                                        <?php if ($defaultType == $typeId) { ?>
                                            <a href="#" title="<?php echo lang('contract_exclude_tip_default_type'); ?>"><i
                                                    class="mdi mdi-star nolink"></i></a>
                                        <?php } else { ?>
                                            <a href="#" title="<?php echo lang('contract_exclude_tip_already_used'); ?>"><i
                                                    class="mdi mdi-alert-circle nolink"></i></a>
                                        <?php } ?>
                                    <?php } ?>
                                </div>
                            </td>
                            <td><?php echo $typeId; ?> &mdash; <span
                                    id="leave_name_<?php echo $typeId; ?>"><?php echo $TypeName; ?></span></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
            </table>
                ...
                <tbody>
                    <?php foreach ($excludedTypes as $typeId => $TypeName): ?>
                        <tr id="leave_row_<?php echo $typeId; ?>">
                            <td>
                                <div class="pull-right">
                                    <a href="#" class="include" data-id="<?php echo $typeId; ?>"
                                        title="<?php echo lang('contract_exclude_tip_include_type'); ?>"><i
