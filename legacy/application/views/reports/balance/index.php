    ...
    <div class="span4">
        ...
        <div class="input-append">
            ...
            <button id="cmdSelectEntity"
                class="btn btn-primary"><?php echo lang('reports_balance_button_entity'); ?></button>
        </div>
    </div>
    <div class="span4">
...
<div id="frmSelectEntity" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_entity();"
            class="btn"><?php echo lang('reports_balance_popup_entity_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectEntity').modal('hide');"
            class="btn"><?php echo lang('reports_balance_popup_entity_button_cancel'); ?></a>
    </div>
</div>
