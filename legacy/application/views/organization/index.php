...
<div class="row-fluid">
    <div class="span4">
        <div class="input-append">
            <input type="text" class="input-medium"
                placeholder="<?php echo lang('organization_index_field_search_placeholder'); ?>" id="txtSearch" />
            <button id="cmdClearSearch" class="btn btn-primary"><i class="mdi mdi-close"></i></button>
            <button id="cmdSearch" class="btn btn-primary"><i
                    class="mdi mdi-magnify"></i>&nbsp;<?php echo lang('organization_index_button_search'); ?></button>
        </div>
    ...
    <div class="span8">
        ...
        <br />
        <button id="cmdAddEmployee"
            class="btn btn-primary"><?php echo lang('organization_index_button_add_employee'); ?></button>
        <button id="cmdRemoveEmployee"
            class="btn btn-primary"><?php echo lang('organization_index_button_remove_employee'); ?></button>
        <br />
        ...
        <div class="input-append">
            ...
            <button id="cmdSelectSupervisor"
                class="btn btn-primary"><?php echo lang('organization_index_button_select_supervisor'); ?></button>
        </div>
        <br /><br />
    </div>
</div>
...
<div id="frmConfirmDelete" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" class="btn btn-danger"
            id="lnkDeleteEntity"><?php echo lang('organization_index_popup_delete_button_yes'); ?></a>
        <a href="#" onclick="$('#organization').jstree('refresh'); $('#frmConfirmDelete').modal('hide');"
            class="btn"><?php echo lang('organization_index_popup_delete_button_no'); ?></a>
    </div>
</div>
...
<div id="frmAddEmployee" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="add_employee();"
            class="btn"><?php echo lang('organization_index_popup_add_button_ok'); ?></a>
        <a href="#" onclick="$('#frmAddEmployee').modal('hide');"
            class="btn"><?php echo lang('organization_index_popup_add_button_cancel'); ?></a>
    </div>
</div>
...
<div id="frmSelectSupervisor" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_supervisor();"
            class="btn"><?php echo lang('organization_index_popup_supervisor_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectSupervisor').modal('hide');"
            class="btn"><?php echo lang('organization_index_popup_supervisor_button_cancel'); ?></a>
    </div>
</div>
...
<div id="frmError" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="$('#frmError').modal('hide');"
            class="btn"><?php echo lang('organization_index_popup_error_button_ok'); ?></a>
    </div>
</div>
