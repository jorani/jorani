...
<body>
    ...
    <br />
    Вы можете <a href="{BaseUrl}hr/counters/collaborators/{UserId}">проверить сальдо по отпускам прежде</a>, чем
    утверждать заявление на отпуск..
    <hr>
