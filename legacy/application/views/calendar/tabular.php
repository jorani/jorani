...
<div class="row-fluid">
    <div class="span4">
        <label for="chkIncludeChildren">
            ...
            &nbsp;(<input type="checkbox" class="input-centered" checked id="chkIncludeChildren"
                name="chkIncludeChildren"> <?php echo lang('calendar_tabular_check_include_subdept'); ?>)
        </label>
        <div class="input-prepend input-append">
            ...
            <button id="cmdSelectEntity" class="btn btn-primary"
                title="<?php echo lang('calendar_tabular_button_select_entity'); ?>"><i
                    class="mdi mdi-sitemap"></i></button>
            <?php if ($mode == 'connected') { ?>
                <button id="cmdSelectList" class="btn btn-primary"
                    title="<?php echo lang('calendar_tabular_button_select_list'); ?>"><i
                        class="mdi mdi-account-multiple"></i></button>
            <?php } ?>
        </div>
    </div>
    <div class="span3">
        ...
        <div class="input-prepend input-append">
            ...
            <input type="text" style="cursor:pointer;" id="txtMonthYear" name="txtMonthYear"
                value="<?php echo $monthName . ' ' . $year; ?>" class="input-medium" readonly />
    ...
    <div class="span3">
        <label for="chkDisplayTypes">
            <input type="checkbox" class="input-centered" checked id="chkDisplayTypes"
                name="chkDisplayTypes"><?php echo lang('calendar_tabular_check_display_types'); ?>
        </label>
    </div>
    <div class="span2">
        <span class="pull-right">
            <button id="cmdExport" class="btn btn-primary"><i
                    class="mdi mdi-download"></i>&nbsp;<?php echo lang('calendar_tabular_button_export'); ?></button>
        </span>
    </div>
</div>
