                ...
                <?php foreach ($requests as $requests_item): ?>
                    <tr>
                        <td data-order="<?php echo $requests_item['id'] ?>">
                            <a href="<?php echo base_url(); ?>extra/overtime/<?php echo $requests_item['id']; ?>"
                                title="<?php echo lang('overtime_index_thead_tip_view'); ?>"><?php echo $requests_item['id']; ?></a>
                            <div class="pull-right">
                                <a href="<?php echo base_url(); ?>extra/overtime/<?php echo $requests_item['id']; ?>"
                                    title="<?php echo lang('overtime_index_thead_tip_view'); ?>"><i
                                        class="mdi mdi-eye nolink"></i></a>
                                &nbsp;
                                <a href="<?php echo base_url(); ?>overtime/accept/<?php echo $requests_item['id']; ?>"
                                    title="<?php echo lang('overtime_index_thead_tip_accept'); ?>"><i
                                        class="mdi mdi-check nolink"></i></a>
                                &nbsp;
                                <a href="<?php echo base_url(); ?>overtime/reject/<?php echo $requests_item['id']; ?>"
                                    title="<?php echo lang('overtime_index_thead_tip_reject'); ?>"><i
                        ...
                        <td data-order="<?php echo $tmpDate; ?>"><?php echo $date->format(lang('global_date_format')); ?>
                        </td>
...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url(); ?>overtime/export/<?php echo $filter; ?>" class="btn btn-primary"><i
                class="mdi mdi-download"></i>&nbsp; <?php echo lang('overtime_index_button_export'); ?></a>
        &nbsp;&nbsp;
        <a href="<?php echo base_url(); ?>overtime/all" class="btn btn-primary"><i
                class="mdi mdi-filter-remove"></i>&nbsp; <?php echo lang('overtime_index_button_show_all'); ?></a>
        &nbsp;&nbsp;
        <a href="<?php echo base_url(); ?>overtime/requested" class="btn btn-primary"><i
                class="mdi mdi-filter"></i>&nbsp; <?php echo lang('overtime_index_button_show_pending'); ?></a>
    </div>
</div>
