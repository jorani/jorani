...
<div class="row-fluid">
  <div class="span12">
    ...
    <div class="input-prepend input-append">
      <button id="cmdDeleteList" class="btn btn-danger"
        title="<?php echo lang('organization_lists_button_delete_list'); ?>"><i
          class="mdi mdi-trash-can-outline"></i></button>
      <button id="cmdRenameList" class="btn btn-primary"
        title="<?php echo lang('organization_lists_button_edit_list'); ?>"><i class="mdi mdi-pencil"></i></button>
      <button id="cmdCreateList" class="btn btn-primary"
        title="<?php echo lang('organization_lists_button_add_list'); ?>"><i class="mdi mdi-plus"></i></button>
      ...
      <button id="cmdAddEmployees" class="btn btn-primary"
        title="<?php echo lang('organization_lists_button_add_users'); ?>"><i class="mdi mdi-account-plus"></i></button>
      <button id="cmdRemoveEmployees" class="btn btn-primary"
        title="<?php echo lang('organization_lists_button_remove_users'); ?>"><i
...
<link href="<?php echo base_url(); ?>assets/datatable/DataTables-1.10.11/css/jquery.dataTables.min.css"
  rel="stylesheet">
<link href="<?php echo base_url(); ?>assets/datatable/RowReorder-1.1.1/css/rowReorder.dataTables.min.css"
...
<script type="text/javascript"
  src="<?php echo base_url(); ?>/assets/datatable/RowReorder-1.1.1/js/dataTables.rowReorder.min.js"></script>
<script type="text/javascript">
  var listId;
  var listName;
