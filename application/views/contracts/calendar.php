...
<h2><?php echo lang('contract_calendar_title'); ?> <span
        class="muted"><?php echo $contract_name; ?></span>&nbsp;<?php echo $help; ?></h2>

<?php echo $flash_partial_view; ?>

<div class="row-fluid">
    <div class="span3">
        <a href="<?php echo base_url() . 'contracts/' . $contract_id . '/calendar/' . (intval($year) - 1); ?>"
            class="btn btn-primary" id="cmdPrevious"><i
                class="mdi mdi-chevron-left"></i>&nbsp;<?php echo intval($year) - 1; ?></a>
        &nbsp;
        <strong><?php echo $year; ?></strong>
        &nbsp;
        <a href="<?php echo base_url() . 'contracts/' . $contract_id . '/calendar/' . (intval($year) + 1); ?>"
            class="btn btn-primary" id="cmdNext"><?php echo intval($year) + 1; ?>&nbsp;<i
                class="mdi mdi-chevron-right"></i></a>
    </div>
    <div class="span2">
        <a href="<?php echo base_url() . 'contracts'; ?>" class="btn btn-primary"><i
                class="mdi mdi-arrow-left-bold"></i>&nbsp; <?php echo lang('contract_calendar_button_back'); ?></a>
    </div>
    <div class="span4">
        <button id="cmdImportCalendar" class="btn btn-primary"><i class="mdi mdi-calendar-text"></i>&nbsp;
            <?php echo lang('contract_calendar_button_import'); ?></button>&nbsp;
        <a href="#frmSetRangeDayOff" class="btn btn-primary" data-toggle="modal"><i
                class="mdi mdi-twitter-retweet"></i>&nbsp; <?php echo lang('contract_calendar_button_series'); ?></a>
    </div>
    <div class="span3">
...
<div class="row-fluid">
    <div class="span6">
        <u><?php echo lang('contract_calendar_legend_title'); ?></u> <img
            src='<?php echo base_url(); ?>assets/images/day.png' />
        <?php echo lang('contract_calendar_legend_allday'); ?>, <img
            src='<?php echo base_url(); ?>assets/images/morning.png' />
        <?php echo lang('contract_calendar_legend_morning'); ?>, <img
            src='<?php echo base_url(); ?>assets/images/afternoon.png' />
        <?php echo lang('contract_calendar_legend_afternoon'); ?>
    </div>
    <div class="span6">
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" id="fullyear">
    ...
    for ($mC = 1; $mC <= 12; $mC++) {
        ...
        for ($i = 1; $i <= $daysInMonth; $i++) {
            ...
            switch ($type) {
                case 1:
                    $image = "<img src='" . base_url() . "assets/images/day.png' />";
                    break;
                case 2:
                    $image = "<img src='" . base_url() . "assets/images/morning.png' />";
                    break;
                case 3:
                    $image = "<img src='" . base_url() . "assets/images/afternoon.png' />";
                    break;
            }
...
<div id="frmAddDayOff" class="modal hide fade">
    ...
    <div class="modal-footer">
        <button id="cmdDeleteDayOff" onclick="deleteDayOff();"
            class="btn btn-danger"><?php echo lang('contract_calendar_popup_dayoff_button_delete'); ?></button>
        <button onclick="setAsDayOff();"
            class="btn"><?php echo lang('contract_calendar_popup_dayoff_button_ok'); ?></button>
        <button onclick="$('#frmAddDayOff').modal('hide');"
            class="btn"><?php echo lang('contract_calendar_popup_dayoff_button_cancel'); ?></button>
    </div>
</div>
...
<div id="frmSetRangeDayOff" class="modal hide fade">
    ...
    <div class="modal-body">
        ...
        <div class="input-append">
            ...
            <button class="btn"
                onclick="setCurrentPeriod();"><?php echo lang('contract_calendar_popup_series_button_current'); ?></button>
        </div><br />
    ...
    <div class="modal-footer">
        <a href="#" onclick="editSeriesOfDaysOff();"
            class="btn"><?php echo lang('contract_calendar_popup_series_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSetRangeDayOff').modal('hide');"
            class="btn"><?php echo lang('contract_calendar_popup_series_button_cancel'); ?></a>
    </div>
</div>
...
<div id="frmLinkICS" class="modal hide fade">
    ...
    <div class="modal-body" id="frmSelectDelegateBody">
        <div class='input-append'>
            ...
            <a href="#" id="tipCopied" data-toggle="tooltip" title="<?php echo lang('copied'); ?>"
                data-placement="right" data-container="#cmdCopy"></a>
        </div>
    </div>
    <div class="modal-footer">
