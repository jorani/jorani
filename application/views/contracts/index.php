            ...
            <tr>
                <td data-order="<?php echo $contracts_item['id']; ?>">
                    ...
                    <div class="pull-right">
                        <a href="#" class="confirm-delete" data-id="<?php echo $contracts_item['id']; ?>"
                            title="<?php echo lang('contract_index_tip_delete'); ?>"><i
                                class="mdi mdi-delete nolink"></i></a>
                        &nbsp;
                        <a href="<?php echo base_url(); ?>contracts/edit/<?php echo $contracts_item['id'] ?>"
                            title="<?php echo lang('contract_index_tip_edit'); ?>"><i class="mdi mdi-pencil nolink"></i></a>
                        &nbsp;
                        <a href="<?php echo base_url(); ?>entitleddays/contract/<?php echo $contracts_item['id'] ?>"
                            title="<?php echo lang('contract_index_tip_entitled'); ?>"><i
                                class="mdi mdi-pencil-box-outline nolink"></i></a>
                        &nbsp;
                        <a href="<?php echo base_url(); ?>contracts/<?php echo $contracts_item['id'] ?>/calendar"
                            title="<?php echo lang('contract_index_tip_dayoffs'); ?>"><i
                                class="mdi mdi-calendar nolink"></i></a>
                        &nbsp;
                        <a href="<?php echo base_url(); ?>contracts/<?php echo $contracts_item['id'] ?>/excludetypes"
                            title="<?php echo lang('contract_index_tip_exclude_types'); ?>"><i
                                class="mdi mdi-cancel nolink"></i></a>
                    </div>
                </td>
...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url(); ?>contracts/export" class="btn btn-primary"><i
                class="mdi mdi-download"></i>&nbsp; <?php echo lang('contract_index_button_export'); ?></a>
        &nbsp;
        <a href="<?php echo base_url(); ?>contracts/create" class="btn btn-primary"><i
                class="mdi mdi-plus-circle"></i>&nbsp; <?php echo lang('contract_index_button_create'); ?></a>
    </div>
</div>
...
<div id="frmDeleteContract" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeleteContract"
            class="btn btn-danger"><?php echo lang('contract_index_popup_delete_button_yes'); ?></a>
        <a href="#" onclick="$('#frmDeleteContract').modal('hide');"
            class="btn"><?php echo lang('contract_index_popup_delete_button_no'); ?></a>
    </div>
</div>
...
<div id="frmEntitledDays" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="$('#frmEntitledDays').modal('hide');"
            class="btn"><?php echo lang('contract_index_popup_entitled_button_close'); ?></a>
    </div>
</div>
