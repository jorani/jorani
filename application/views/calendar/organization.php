...
<div class="row-fluid">
    <div class="span5">
        <label for="chkIncludeChildren">
            ...
            (<input type="checkbox" class="input-centered" checked id="chkIncludeChildren" name="chkIncludeChildren">
            <?php echo lang('calendar_organization_check_include_subdept'); ?>)
        </label>
        <div class="input-prepend input-append">
            ...
            <button id="cmdSelectEntity" class="btn btn-primary"
                title="<?php echo lang('calendar_organization_button_select_entity'); ?>"><i class="mdi mdi-sitemap"
                    aria-hidden="true"></i></button>
            <?php if ($mode == 'connected') { ?>
                <button id="cmdSelectList" class="btn btn-primary"
                    title="<?php echo lang('calendar_tabular_button_select_list'); ?>"><i class="mdi mdi-account-multiple"
                        aria-hidden="true"></i></button>
            <?php } ?>
        </div>
    </div>
    <div class="span5">
        <label for="chkIncludeDaysOffs">
            <input type="checkbox" class="input-centered" checked id="chkIncludeDaysOffs" name="chkIncludeDaysOffs">
            <?php echo lang('calendar_individual_day_offs'); ?>
        </label>
        <div class="input-prepend input-append">
            <button id="cmdPrevious" class="btn btn-primary"
                title="<?php echo lang('calendar_tabular_button_previous'); ?>"><i
                    class="mdi mdi-chevron-left"></i></button>
            <input type="text" id="txtMonthYear" style="cursor:pointer;" value="<?php echo $monthName . ' ' . $year; ?>"
                class="input-medium" readonly />
            <button id="cmdNext" class="btn btn-primary" title="<?php echo lang('calendar_tabular_button_next'); ?>"><i
...
<div id="frmSelectEntity" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_entity();"
            class="btn btn-primary"><?php echo lang('calendar_organization_popup_entity_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectEntity').modal('hide');"
            class="btn"><?php echo lang('calendar_organization_popup_entity_button_cancel'); ?></a>
    </div>
</div>
...
<div id="frmLinkICS" class="modal hide fade">
    ...
    <div class="modal-body" id="frmSelectDelegateBody">
        <div class='input-append'>
            ...
            <a href="#" id="tipCopied" data-toggle="tooltip" title="copied" data-placement="right"
