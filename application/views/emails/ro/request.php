...
<body>
    <h3>{Title}</h3>
    {Firstname} {Lastname} are o cerere de concediu. Vezi <a href="{BaseUrl}leaves/requests/{LeaveId}">detaliile</a> mai
    jos:<br />
    <table border="0">
        <tr>
            <td>De la &nbsp;</td>
    ...
    <br />
    Poți verifica <a href="{BaseUrl}hr/counters/collaborators/{UserId}">balanța concediilor</a> înainte de a valida
    cererea.
    <hr>
