...
<body>
    <h3>{Title}</h3>
    {Firstname} {Lastname} zrušen požadovaný čas. Prosím podívejte se na <a href="{BaseUrl}leaves/{LeaveId}">detaily</a>
    níže:<br />
    <table border="0">
        <tr>
            <td>Od &nbsp;</td>
    ...
    <br />
    Můžete zkontrolovat <a href="{BaseUrl}hr/counters/collaborators/{UserId}">zůstatek dovolené</a> předtím odesláním ke
    schválení.
    <hr>
