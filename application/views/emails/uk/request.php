...
<body>
    <h3>{Title}</h3>
    {Firstname} {Lastname} відправив заяву на відпустку. <a href="{BaseUrl}leaves/requests/{LeaveId}">Подробиці</a>
    нижче:
    <table border="0">
        <tr>
            <td>Від &nbsp;</td>
    ...
    <br />
    Ви можете перевірити <a href="{BaseUrl}hr/counters/collaborators/{UserId}">сальдо по відпустках</a> перед
    затвердженням заяви.
    <hr>
