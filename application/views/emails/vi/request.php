...
<body>
    <h3>{Title}</h3>
    {Firstname} {Lastname} đã yêu cầu nghỉ phép. <a href="{BaseUrl}leaves/requests/{LeaveId}">Xem chi tiết</a> bên
    dưới:<br />
    <table border="0">
        <tr>
            <td>Từ</td>
    ...
    <br />
    Bạn có thể kiểm tra <a href="{BaseUrl}hr/counters/collaborators/{UserId}">số ngày nghỉ còn lại</a> trước khi xác
    nhận yêu cầu nghỉ phép.
    <hr>
