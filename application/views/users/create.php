        ...
        <div class="control-group">
            <label class="control-label" for="txtManager">
                ...
                <a style="color:black;" href="#" data-toggle="tooltip"
                    title="<?php echo lang('users_create_field_manager_description'); ?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-append">
                        ...
                        <a class="btn" id="cmdGeneratePassword"><i
                                class="mdi mdi-refresh"></i>&nbsp;<?php echo lang('users_create_button_generate_password'); ?></a>
                    </div>
                </div>
            </div>
        <?php } else { ?>
            ...
            <div class="controls">
                <select name="language">
                    ...
                    foreach ($languages as $code => $language): ?>
                        <option value="<?php echo $code; ?>" <?php if ($code == $default_lang)
                               echo "selected"; ?>>
                            <?php echo $language; ?>
                        </option>
                    <?php endforeach ?>
...
<div id="frmSelectManager" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_manager();"
            class="btn"><?php echo lang('users_create_popup_manager_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectManager').modal('hide');"
            class="btn"><?php echo lang('users_create_popup_manager_button_cancel'); ?></a>
    </div>
</div>
...
<div id="frmSelectEntity" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_entity();"
            class="btn"><?php echo lang('users_create_popup_entity_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectEntity').modal('hide');"
            class="btn"><?php echo lang('users_create_popup_entity_button_cancel'); ?></a>
    </div>
</div>
...
<div id="frmSelectPosition" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="select_position();"
            class="btn"><?php echo lang('users_create_popup_position_button_ok'); ?></a>
        <a href="#" onclick="$('#frmSelectPosition').modal('hide');"
            class="btn"><?php echo lang('users_create_popup_position_button_cancel'); ?></a>
    </div>
</div>
