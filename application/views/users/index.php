                            ...
                            <div class="pull-right">
                                <?php if ($users_item['id'] != $this->session->userdata('id')) { ?>
                                    <?php if ($users_item['active']) { ?>
                                        <a href="#" class="action-disable" data-id="<?php echo $users_item['id']; ?>"
                                            title="<?php echo lang('users_index_thead_tip_active'); ?>"><i
                                                class="mdi mdi-account-off nolink"></i></a>
                                    <?php } else { ?>
                                        <a href="#" class="action-enable" data-id="<?php echo $users_item['id']; ?>"
                                            title="<?php echo lang('users_index_thead_tip_inactive'); ?>"><i
                                                class="mdi mdi-account mdi-dark mdi-inactive"></i></a>
                                    <?php } ?>
                                <?php } ?>
                                &nbsp;
                                <a href="<?php echo base_url(); ?>users/edit/<?php echo $users_item['id'] ?>"
                                    title="<?php echo lang('users_index_thead_tip_edit'); ?>"><i
                                        class="mdi mdi-account-edit nolink"></i></a>
                                &nbsp;
                                <?php if ($users_item['id'] != $this->session->userdata('id')) { ?>
                                    <a href="#" class="confirm-delete" data-id="<?php echo $users_item['id']; ?>"
                                        title="<?php echo lang('users_index_thead_tip_delete'); ?>"><i
                                            class="mdi mdi-delete nolink"></i></a>
                                    &nbsp;
                                <?php } ?>
                                <a href="<?php echo base_url(); ?>users/reset/<?php echo $users_item['id'] ?>"
                                    title="<?php echo lang('users_index_thead_tip_reset'); ?>" data-target="#frmResetPwd"
                                    data-toggle="modal"><i class="mdi mdi-lock nolink"></i></a>
                            </div>
                        </td>
                        <td><?php echo $users_item['firstname']; ?></td>
                        <td><?php echo $users_item['lastname']; ?></td>
                        <td><?php echo $users_item['login']; ?></td>
                        <td><a href="mailto:<?php echo $users_item['email']; ?>"><?php echo $users_item['email']; ?></a>
                        </td>
...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url(); ?>users/export" class="btn btn-primary"><i
                class="mdi mdi-download"></i>&nbsp;<?php echo lang('users_index_button_export'); ?></a>
        &nbsp;
        <a href="<?php echo base_url(); ?>users/create" class="btn btn-primary"><i
                class="mdi mdi-account-plus"></i>&nbsp;<?php echo lang('users_index_button_create_user'); ?></a>
    </div>
</div>
...
<div id="frmConfirmDelete" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" class="btn btn-danger"
            id="action-delete"><?php echo lang('users_index_popup_delete_button_yes'); ?></a>
        <a href="#" onclick="$('#frmConfirmDelete').modal('hide');"
            class="btn"><?php echo lang('users_index_popup_delete_button_no'); ?></a>
    </div>
</div>
...
<div id="frmResetPwd" class="modal hide fade">
    ...
    <div class="modal-footer">
        <button class="btn"
            data-dismiss="modal"><?php echo lang('users_index_popup_password_button_cancel'); ?></button>
    </div>
</div>
...
<div id="frmImportUsers" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" onclick="$('#frmImportUsers').modal('hide');"
