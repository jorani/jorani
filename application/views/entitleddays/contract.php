...
<div class="row-fluid">
    <div class="span12">
        ...
        <h2><?php echo lang('entitleddays_contract_index_title'); ?> <span
                    ...
                    <tr data-id="<?php echo $days['id']; ?>">
                        <td>
                            <a href="#" onclick="delete_entitleddays(<?php echo $days['id'] ?>);"
                                title="<?php echo lang('entitleddays_contract_index_thead_tip_delete'); ?>"><i
                                    class="mdi mdi-close nolink"></i></a>
                            &nbsp;<a href="#" onclick="copy_entitleddays(<?php echo $days['id'] ?>);"
                                title="<?php echo lang('entitleddays_contract_index_thead_tip_copy'); ?>"><i
                                    class="mdi mdi-content-copy nolink"></i></a>
                            &nbsp;<a href="#" onclick="show_edit_entitleddays(<?php echo $days['id'] ?>);"
                                title="<?php echo lang('entitleddays_contract_index_thead_tip_edit'); ?>"><i
        ...
        <div class="row-fluid">
            <div class="span6">
                <a href="<?php echo base_url(); ?>contracts" class="btn btn-danger"><i
                        class="mdi mdi-arrow-left-bold"></i>&nbsp;<?php echo lang('entitleddays_contract_index_button_back'); ?></a>
                <button id="cmdAddEntitledDays" class="btn btn-primary" onclick="show_add_entitleddays();"><i
                        class="mdi mdi-plus-circle"></i>&nbsp;<?php echo lang('entitleddays_contract_index_button_add'); ?></button>
            </div>
            <div class="span6">
...
<div id="frmAddEntitledDays" class="modal hide fade">
    ...
    <div class="modal-footer">
        ...
        <button id="cmdFrmAddEntitledDays" class="btn btn-primary"
            onclick="add_entitleddays();"><?php echo lang('entitleddays_contract_index_button_add'); ?></button>
        <button class="btn btn-danger"
            onclick="$('#frmAddEntitledDays').modal('hide');"><?php echo lang('entitleddays_contract_index_button_cancel'); ?></button>
    </div>
</div>
