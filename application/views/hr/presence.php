...
<div class="row-fluid">
    <div class="span12">
        ...
        <h2><?php echo lang('hr_presence_title'); ?><span class="muted">&nbsp;(<?php echo $employee_name; ?>&nbsp;
                |&nbsp;<?php echo lang($month_name); ?>&nbsp;<?php echo $year; ?>)</span> &nbsp;<?php echo $help; ?>
        </h2>
        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <p><?php echo lang('hr_presence_month'); ?> :
                    <b><?php echo lang($month_name); ?>&nbsp;<?php echo $year; ?></b>
                </p>
                ...
                <?php if ($contract_id != '') { ?>
                    ...
                    <?php } else { ?>
                        <p><?php echo lang('hr_presence_non_working_days'); ?> : <b><a
                                    href="<?php echo base_url(); ?>contracts/<?php echo $contract_id; ?>/calendar"><?php echo $non_working_days; ?></a></b>
                        </p>
                    <?php } ?>
                <?php } else { ?>
                    <p><?php echo lang('hr_presence_contract'); ?> : <i
                            class="mdi mdi-alert"></i><?php echo lang('hr_presence_no_contract'); ?></p>
                    <p><?php echo lang('hr_presence_working_days'); ?> : <i
                            class="mdi mdi-alert"></i><?php echo lang('hr_presence_no_contract'); ?></p>
                    <p><?php echo lang('hr_presence_non_working_days'); ?> : <i
                            class="mdi mdi-alert"></i><?php echo lang('hr_presence_no_contract'); ?></p>
                <?php } ?>
                <p><?php echo lang('hr_presence_work_duration'); ?> : <b><?php echo $work_duration; ?></b>&nbsp;<i
                        class="mdi mdi-alert-circle-outline"></i><?php echo lang('hr_presence_please_check'); ?></p>
                <p><?php echo lang('hr_presence_leave_duration'); ?> : <b><?php echo $leave_duration; ?></b>&nbsp;<i
                        class="mdi mdi-alert-circle-outline"></i><?php echo lang('hr_presence_please_check'); ?></p>
            ...
            <div class="span3">
                ...
                <button id="cmdExecute"
                    class="btn btn-primary"><?php echo lang('hr_presence_button_execute'); ?></button>
                <button id="cmdNext" class="btn btn-primary"><i class="mdi mdi-chevron-right"></i></button>
                <br /><br />
                <a href="<?php echo base_url() . 'hr/presence/export/' . $source . '/' . $user_id . '/' . $month . '/' . $year; ?>"
                    class="btn btn-primary"><i
                        class="mdi mdi-download"></i>&nbsp;<?php echo lang('hr_presence_button_export'); ?></a>
            </div>
        </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            for ($ii = 1; $ii <= $lastDay; $ii++) {
                                ...
                                switch ($dayNum) {
                                    case 1:
                                        echo '<td><b>' . lang('calendar_monday_short') . '</b></td>';
                                        break;
                                    case 2:
                                        echo '<td><b>' . lang('calendar_tuesday_short') . '</b></td>';
                                        break;
                                    case 3:
                                        echo '<td><b>' . lang('calendar_wednesday_short') . '</b></td>';
                                        break;
                                    case 4:
                                        echo '<td><b>' . lang('calendar_thursday_short') . '</b></td>';
                                        break;
                                    case 5:
                                        echo '<td><b>' . lang('calendar_friday_short') . '</b></td>';
                                        break;
                                    case 6:
                                        echo '<td><b>' . lang('calendar_saturday_short') . '</b></td>';
                                        break;
                                    case 7:
                                        echo '<td><b>' . lang('calendar_sunday_short') . '</b></td>';
                                        break;
                                }
                            } ?>
                        </tr>
                ...
                <?php foreach ($leaves as $leave):
                    ...
                    <tr>
                        <td data-order="<?php echo $leave['id']; ?>">
                            <a href="<?php echo base_url(); ?>leaves/edit/<?php echo $leave['id']; ?>?source=hr%2Fpresence%2Femployees%2F<?php echo $user_id; ?>%2F<?php echo $month; ?>%2F<?php echo $year; ?>"
                                title="<?php echo lang('hr_presence_thead_tip_edit'); ?>"><?php echo $leave['id'] ?></a>
                        </td>
                        <td data-order="<?php echo $tmpStartDate; ?>">
                            <?php echo $startdate . ' (' . lang($leave['startdatetype']) . ')'; ?>
                        </td>
                        <td data-order="<?php echo $tmpEndDate; ?>">
                            <?php echo $enddate . ' (' . lang($leave['enddatetype']) . ')'; ?>
                        </td>
        ...
        <div class="row-fluid">
            <div class="span12">
                <h3><?php echo lang('hr_summary_title'); ?>&nbsp;<?php echo $employee_id; ?>&nbsp;<span class="muted">
                        (<?php echo $employee_name; ?>)</span>&nbsp;<?php echo $help; ?></h3>
                    ...
                    <table id="counters" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                        ...
                        <tbody>
                            <?php foreach ($summary as $key => $value) { ?>
                                <tr>
                                    <td><?php echo $key; ?></td>
                                    <td><?php echo round(((float) $value[1] - (float) $value[0]), 3, PHP_ROUND_HALF_DOWN); ?>
                                    </td>
                                    <td><?php if ($value[2] == '') {
                                        echo ((float) $value[0]);
                                    } else {
        ...
        <div class="row-fluid">
            <div class="span12">
                <?php if ($source == 'employees') { ?>
                    <a href="<?php echo base_url(); ?>hr/employees" class="btn btn-primary"><i
                            class="mdi mdi-arrow-left-bold"></i>&nbsp;<?php echo lang('hr_presence_button_list'); ?></a>
                <?php } else { ?>
                    <a href="<?php echo base_url(); ?>requests/collaborators" class="btn btn-primary"><i
                            class="mdi mdi-arrow-left-bold"></i>&nbsp;<?php echo lang('hr_presence_button_list'); ?></a>
                <?php } ?>
            </div>
        </div>
...
<?php if ($language_code != 'en') { ?>
    <script type="text/javascript"
        src="<?php echo base_url(); ?>assets/fullcalendar-2.8.0/lang/<?php echo strtolower($language_code); ?>.js"></script>
<?php } ?>
