            ...
            <tbody>
                ...
                foreach ($events as $event) {
                    ...
                    switch ($event['change_type']) {
                        case 0:
                            $objLeave->typeIcon = 'icon-info-sign';
                            break;
                        case 1:
                            $objLeave->typeIcon = 'icon-plus';
                            break;
                        case 2:
                            $objLeave->typeIcon = 'icon-pencil';
                            break;
                        case 3:
                            $objLeave->typeIcon = 'icon-trash';
                            break;
                    }
                ...
                <?php foreach ($history as $objLeave): ?>
                    <tr>
                        ...
                        switch (intval($objLeave->status)) {
                            case LMS_PLANNED:
                                echo "<td><span class='label'>" . lang($objLeave->statusName) . "</span></td>";
                                break;
                            case LMS_REQUESTED:
                                echo "<td><span class='label label-warning'>" . lang($objLeave->statusName) . "</span></td>";
                                break;
                            case LMS_ACCEPTED:
                                echo "<td><span class='label label-success'>" . lang($objLeave->statusName) . "</span></td>";
                                break;
                            default:
                                echo "<td><span class='label label-important' style='background-color: #ff0000;'>" . lang($objLeave->statusName) . "</span></td>";
                                break;
                        } ?></td>
                    </tr>
                <?php endforeach ?>
