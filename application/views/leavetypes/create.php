...
<div class="input-append">
    ...
    <a id="cmdSuggestAcronym" class="btn btn-primary"
        title="<?php echo lang('leavetypes_popup_create_button_suggest'); ?>">
...
<button id="cmdCreateLeaveType"
    class="btn btn-primary"><?php echo lang('leavetypes_popup_create_button_create'); ?></button>
