                ...
                <?php foreach ($extras as $extra_item): ?>
                    <tr>
                        <td data-order="<?php echo $extra_item['id']; ?>">
                            <a href="<?php echo base_url(); ?>extra/extra/<?php echo $extra_item['id']; ?>"
                                title="<?php echo lang('extra_index_thead_tip_view'); ?>"><?php echo $extra_item['id']; ?></a>
                            &nbsp;
                            <div class="pull-right">
                                <a href="<?php echo base_url(); ?>extra/extra/<?php echo $extra_item['id']; ?>"
                                    title="<?php echo lang('extra_index_thead_tip_view'); ?>"><i
                                        class="mdi mdi-eye nolink"></i></a>
                                &nbsp;
                                <?php if ($extra_item['status'] == 1) { ?>
                                    <a href="<?php echo base_url(); ?>extra/edit/<?php echo $extra_item['id']; ?>"
                                        title="<?php echo lang('extra_index_thead_tip_edit'); ?>"><i
                                            class="mdi mdi-pencil nolink"></i></a>
                                    &nbsp;
                                    <a href="#" class="confirm-delete" data-id="<?php echo $extra_item['id']; ?>"
                                        title="<?php echo lang('extra_index_thead_tip_delete'); ?>"><i
...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url(); ?>extra/export" class="btn btn-primary"><i class="mdi mdi-download"></i>&nbsp;
            <?php echo lang('extra_index_button_export'); ?></a>
        &nbsp;
        <a href="<?php echo base_url(); ?>extra/create" class="btn btn-primary"><i
                class="mdi mdi-plus-circle"></i>&nbsp;
            <?php echo lang('extra_index_button_create'); ?></a>
    </div>
</div>
...
<div id="frmDeleteExtraRequest" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeleteUser"
            class="btn btn-danger"><?php echo lang('extra_index_popup_delete_button_yes'); ?></a>
        <a href="#" onclick="$('#frmDeleteExtraRequest').modal('hide');"
            class="btn"><?php echo lang('extra_index_popup_delete_button_no'); ?></a>
    </div>
</div>
